...
const FeatureCard: React.FC<FeatureCardProps> = ({ Icon, title, description }) => (
  <div className="bg-white p-6 rounded-lg shadow-lg hover:shadow-xl transition-shadow duration-300 flex flex-col items-center text-center">
    ...
    <h3 className="text-xl font-heading font-semibold mb-2 text-blue-900">{title}</h3>
...
const OrganizerLandingPage: React.FC = () => {
  ...
  return (
    <div className="bg-[url('/organizer/bg/bg_events_collection.png')] bg-cover bg-center min-h-screen">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-32">
        <div className="text-center">
          <h1 className="text-4xl sm:text-5xl md:text-6xl font-heading font-extrabold text-white leading-tight mb-6">
            Elevate Your Events with Our Platform
          </h1>
          <p className="text-xl md:text-2xl text-blue-100 mb-10 max-w-3xl mx-auto font-body">
          ...
          <div className="flex flex-col sm:flex-row justify-center space-y-4 sm:space-y-0 sm:space-x-4">
            <Link to='/register-organizer' className="bg-white text-blue-900 hover:bg-blue-100 transition-colors duration-300 px-8 py-3 rounded-full font-display font-semibold text-lg">
              Get Started
            </Link>
            <button className="border-2 border-white text-white hover:bg-white hover:text-blue-900 transition-colors duration-300 px-8 py-3 rounded-full font-display font-semibold text-lg">
              Learn More
            </button>
          </div>
        </div>
      ...
      <div className="bg-blue-100 py-24">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-center mb-16 text-blue-900">
      ...
      <div className="w-full h-[300px] bg-cover bg-center bg-[url('/user/bg/event-explore-search-bg.png')]">
        ...
        >
          <div className="text-center text-white">
            <div className='text-left p-4 bg-blue-900 shadow-md rounded-lg'>
              <h2 className="text-2xl font-heading font-bold mb-2">Ready to Manage Your Events?</h2>
              <p className="mb-4 font-body">If you already have an account, log in to access your dashboard and start organizing!</p>
              <Link to="/login-organizer" className="bg-white text-blue-900 hover:bg-blue-100 transition-colors duration-300 px-6 py-2 rounded-full font-display font-semibold">
                Log In
              </Link>
            </div>
          </div>
