...
import { createOnlineEventTimeSlots, getOnlineEventTimeSlot } from '../../../../redux/action/organizerActions';
...
const EventTimeSlots: React.FC<EventTimeSlotsProps> = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (validateAllSlots() && id) {
      dispatch(createOnlineEventTimeSlots({ 
        id, 
        slots: timeSlots 
      }))
      .unwrap()
  ...
  const onPrevious = () => {
    navigate(`/organizer/online-event/details/${id}`);
  }
